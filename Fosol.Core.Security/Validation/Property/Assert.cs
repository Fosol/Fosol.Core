...
namespace Fosol.Core.Security.Validation.Property
{
    /// <summary>
    ...
    public static class Assert
    {
        ...
        /// </summary>
        /// <exception cref="Fosol.Core.Validation.Exceptions.PropertyException">Parameter 'passwordStrengthRegularExpression' cannot be empty or white space.</exception>
        /// <exception cref="Fosol.Core.Validation.Exceptions.PropertyNullException">Parameters 'password', and 'passwordStrengthRegularExpression' cannot be null.</exception>
        ...
        public static void IsValidPassword(string password, string passwordStrengthRegularExpression, string paramName, string message = null, Exception innerException = null)
        {
            if (!PasswordHelper.IsValid(password, passwordStrengthRegularExpression))
                throw new PropertyException(String.Format(message ?? Resources.Multilingual.Validation_Property_Assert_IsValidPassword, paramName), paramName, innerException);
        }
        ...
        /// </summary>
        /// <exception cref="Fosol.Core.Validation.Exceptions.PropertyException">Parameter 'passwordStrengthRegularExpression' cannot be empty or white space.</exception>
        /// <exception cref="Fosol.Core.Validation.Exceptions.PropertyNullException">Parameters 'password', and 'requirements' cannot be null.</exception>
        /// <param name="password">The value to check.</param>
