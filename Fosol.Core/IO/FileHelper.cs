...
{
    /// <summary>
    /// FileHelper static class, provides methods for helping with files.
    /// </summary>
    public static class FileHelper
    {
        ...
        /// <returns>Content type registered for the specified extension, or "application/octet-stream" if one is not found.</returns>
        public static string GetContentType(string extension)
        {
#if !WINDOWS_PHONE
            // Registry provides extension and content type mappings.
