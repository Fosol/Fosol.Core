...
{
    /// <summary>
    /// DataContractHelper static class, provides methods for serializing objects with the DataContractSerializer object.
    /// </summary>
    public static class DataContractHelper
    {
        ...
        public static string Serialize(object data)
        {
            ...
            {
                DataContractHelper.Serialize(data, stream);
